# -*- coding: utf-8 -*-
"""
SCRAPER FÚTBOL DINÁMICO - Extrae resultados desde soccerway.com
...
# Ligas populares con URLs correctas
LIGAS_SOCCERWAY = {
...
if __name__ == "__main__":
    scraper = ScraperFutbolDinamico()
    
    for nombre, url in LIGAS_SOCCERWAY.items():
        print(f"\n📡 Scrapeando {nombre}...")
        partidos = scraper.get_games(url)
        if partidos:
