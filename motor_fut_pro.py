...
def analizar_futbol_pro_v20(partido_data, historial_db=None):
    ...
    home = partido_data.get('home', '')
    away = partido_data.get('away', '')
    ...
    recs = []
    if prob_home_win > 0.60: recs.append("✅ ML HOME")
    if exp_total > partido_data.get('total_line', 0) + 0.6: recs.append("✅ OVER GOLES")
...
def backtest_futbol_pro_v20(df_hist=None, n=300):
