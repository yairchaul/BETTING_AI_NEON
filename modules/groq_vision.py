...
class GroqVisionParser:
    def __init__(self):
        ...
        # Modelo de visión actualizado (el anterior estaba descontinuado)
        self.model = "llama-3.2-11b-vision-preview"  # Modelo actualizado
    ...
    def extract_matches_with_vision(self, image_bytes):
        ...
        try:
            ...
            Extrae TODOS los partidos y devuélvelos en formato JSON:
            [
              {
